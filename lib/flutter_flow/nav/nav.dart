...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomeWidget() : Auth2LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'authcallback',
          path: '/authcallback',
          builder: (context, params) => AuthcallbackWidget(
        ...
        FFRoute(
          name: 'tokencallback',
          path: '/tokencallback',
          builder: (context, params) => TokencallbackWidget(),
        ),
        FFRoute(
          name: 'AdBannerPage',
          path: '/adBannerPage',
          builder: (context, params) => AdBannerPageWidget(),
        )
